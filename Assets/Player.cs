...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource hittingSoundEffect;
    [SerializeField] private AudioSource dyingSoundEffect;
    [SerializeField] private AudioSource groundCollisionSound;
    void Start()
    {
    ...
    {
        if (isDead && !hasPlayedDyingSound)
        {
            if (dyingSoundEffect != null)
            {
        ...
        if (!isGrounded)
        {
            ...
            if (hit2D.collider != null)
            {
                ...
                if (ground != null)
                {
                    ...
                    if (groundCollisionSound != null)
                {
                    groundCollisionSound.Play();
                }
                }
            }
